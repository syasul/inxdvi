...
<body class="antialiased selection:bg-[#4f46e5]/20 selection:text-[#4f46e5]">
    ...
    <section id="layanan" class="py-28 bg-[var(--bg-main)] border-t border-black/10 dark:border-white/10 relative z-20 transition-colors duration-500">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 border border-black/10 dark:border-white/10 rounded-3xl overflow-hidden bg-[var(--bg-card)] shadow-sm transition-colors duration-500">
                <!-- Service 1 -->
                <div class="spotlight-card p-8 border-b md:border-b-0 md:border-r border-black/10 dark:border-white/10 hover:bg-black/[0.02] dark:hover:bg-white/[0.01] transition-colors group">
                ...
                <!-- Service 3 -->
                <div class="spotlight-card p-8 hover:bg-black/[0.02] dark:hover:bg-white/[0.01] transition-colors group">
                    <div class="w-12 h-12 rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center mb-8 text-zinc-800 dark:text-white group-hover:bg-zinc-900 dark:group-hover:bg-white group-hover:text-white dark:group-hover:text-black transition-all">
                ...
                <!-- Row 2 -->
                <div class="spotlight-card p-8 border-t border-r border-black/10 dark:border-white/10 hover:bg-black/[0.02] dark:hover:bg-white/[0.01] transition-colors group border-b md:border-b-0">
                    <div class="w-12 h-12 rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center mb-8 text-zinc-800 dark:text-white group-hover:bg-zinc-900 dark:group-hover:bg-white group-hover:text-white dark:group-hover:text-black transition-all">
                ...
                <div class="spotlight-card p-8 border-t border-black/10 dark:border-white/10 hover:bg-black/[0.02] dark:hover:bg-white/[0.01] transition-colors group">
                    <div class="w-12 h-12 rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center mb-8 text-zinc-800 dark:text-white group-hover:bg-zinc-900 dark:group-hover:bg-white group-hover:text-white dark:group-hover:text-black transition-all">
    ...
    <section id="hemat" class="py-24 bg-[var(--bg-main)] border-t border-black/10 dark:border-white/10 relative z-20 transition-colors duration-500">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl p-8 shadow-sm transition-colors duration-500">
    ...
    <section class="py-24 bg-[var(--bg-main)] border-t border-black/10 dark:border-white/10 relative z-20 transition-colors duration-500">
        <div class="max-w-4xl mx-auto bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl p-8 md:p-14 text-center shadow-sm transition-colors duration-500">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start relative">
                ...
                <div class="space-y-8 md:py-8">
                    <!-- Step 1 -->
                    <div class="step-item p-8 bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl shadow-sm hover:border-black/30 dark:hover:border-white/30 transition-all duration-300">
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed font-light" data-i18n="step_1_desc">Ceritakan masalah bisnis Anda, kami dengarkan dan beri solusi terbaik.</p>
                    </div>
                    <!-- Step 2 -->
                    <div class="step-item p-8 bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl shadow-sm hover:border-black/30 dark:hover:border-white/30 transition-all duration-300">
                        <div class="flex items-center justify-between mb-6">
    ...
    <section id="testimoni" class="py-24 bg-[var(--bg-main)] border-t border-black/10 dark:border-white/10 relative z-20 transition-colors duration-500">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-3xl md:text-5xl font-extrabold text-zinc-900 dark:text-white font-headings mb-16 text-center" data-i18n="sec_client_title">Kata Klien Kami</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Testimonial 1 -->
                <div class="p-8 bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl shadow-sm hover:border-black/30 dark:hover:border-white/30 transition-all">
                ...
                <!-- Testimonial 2 -->
                <div class="p-8 bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl shadow-sm hover:border-black/30 dark:hover:border-white/30 transition-all md:-translate-y-4">
                    <div class="flex items-center gap-4 mb-6">
    ...
    <section id="blog" class="py-24 bg-[var(--bg-main)] border-t border-black/10 dark:border-white/10 relative z-20 transition-colors duration-500">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Blog 1 -->
                <div class="bg-[var(--bg-card)] border border-black/10 dark:border-white/10 rounded-3xl overflow-hidden group shadow-sm transition-colors duration-500">
    ...
    <script>
        ...
        // 12. Dark Mode Toggle, Failsafe SVG fill updating
